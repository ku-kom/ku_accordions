...
\TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\B13\Container\Tca\Registry::class)->configureContainer(
    (
        new \B13\Container\Tca\ContainerConfiguration(
            'ku-accordions', // CType
            'KU accordions', // label
            'Create accordions with various content', // description
            [
                [
                    ['name' => 'Add accordion content', 'colPos' => 203, 'allowed' => ['CType' => 'text, textmedia, textpic, image']]
                ]
            ] // grid configuration
        )
    )
    ->setIcon('EXT:ku_accordions/Resources/Public/Icons/Accordion.svg')
);
